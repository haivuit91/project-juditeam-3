...
INSERT INTO `tbl_slide` VALUES (1,'Những nguyên lý cơ bản của chủ nghĩa Mác – Lênin','Chương mở đầu Nhập môn những nguyên lý cơ bản của chủ nghĩa Mác - Lênin nhằm giải quyết ba vấn đề thông lệ của một môn học trước khi đi vào các nội dung cụ thể, đó là: Học cái gì? (đối tượng của môn học); học để làm gì? (mục đích của môn học); và, cần phải học thế nào để đạt được mục đích đó?',2014,1,1,1),(2,'Toán cao cấp 1 (Giải tích)','Trang bị cho sinh viên những kiến thức cơ bản về Giải tích toán học, thực sự cần thiết cho việc tiếp cận với các mô hình phân tích quá trình ra quyết định trong kinh tế và quản lý: Hàm số và giới hạn; Phép toán vi phân đối với hàm số một biến số; Hàm nhiều biến và hàm ẩn ; Các bài toán cực trị ; Phép tính tích phân ; Phương trình vi phân.',2014,2,2,1),(3,'Nguyên lý kế toán','Lịch sử kế toán: \r\nSự hình thành và phát triển của khoa học kế toán gắn liền với sự hình thành và phát triển của \r\nđời sống kinh tế, xã hội loài người từ thấp lên cao mà khởi điểm là nền sản xuất hàng hóa. Trong \r\ngiai đoạn này công việc sản xuất không chỉ nhằm tự túc trong một gia đình hay bộ tộc mà xã hội đã \r\ncó sự trao đổi sản phẩm giữa những người sản xuất với nhau từ đó yêu cầu theo dõi, tính toán hiệu \r\nquả của những hoạt động này đã được đặt ra nhằm mục đích khai thác một cách tốt nhất năng lực ',2014,3,3,1),(4,'Kiểm toán căn bản','Chuyển toán là quá trình các chuyên gia độc lập và thẩm quyền thu nhập và đánh giá các bằng chứng về các thông tin có thể định lượng được của đơn vị cụ thể, nhằm mục đích xác nhận và bào cáo về mức độ phù hợp giữa các thông tin này với các chuẩn mực đã được thiết lập.',2014,4,4,1),(5,'Triết học Mác - Lênin','Triết học Mác - Lênin là một trong ba bộ phận cấu thành của Chủ nghĩa Mác – Lênin; đầu tiên là Triết học Mác, do Mác và Enghen sáng lập ra, được Lênin và các nhà mácxít khác phát triển thêm. ',2014,5,5,1),(6,'Kinh tế chính trị Mác - Lênin','inh tế chính trị Mác - Lênin là một trong các môn khoa học góp phần đào tạo nên những con người không chỉ có năng lực chuyên môn nghiệp vụ mà còn có phẩm chất chính trị đạo đức đáp ứng được đòi hỏi của sự nghiệp công nghiệp hóa, hiện đại hóa đất nước theo định hướng xã hội chủ nghĩa',2014,6,6,1),(7,'Tiếng Anh (A1)','I. Nice to meet you\r\nII. I\'m not English\r\nIII. His name, her name',2014,7,7,1),(8,'Tiếng anh chuyên ngành QTKD','Bạn bắt đầu học bài đầu tiên của phần tiếng Anh chuyên ngành Quản trị kinh doanh. Bài \r\nđược bố cục theo trình tự như sau: mục đích, bài đọc 1, phần thực hành ngôn ngữ, bài đọc 2, bài \r\nluyện nghe, tóm tắt nội dung bài học, bảng từ vựng, phần bài tập và đáp án cho tất cả các bài tập. \r\n',2014,8,8,1),(9,'Đại cương về quản trị kinh doanh ngân hàng','Vào thế kỷ III, các thợ kim hoàn bắt đầu nhận các khoản tiển gửi, tài sản quý của khách hàng và thu một khoản phí nhất định. Sang thế kỷ X các thợ kim hoàn nhận thấy không chỉ có thể hưởng các khoản phí mà họ còn có thể hưởng lợi ích từ việc sử dụng tiền của người này cho người khác vay. Lúc này hoạt động của một ngân hàng thực thụ ra đời bao gồm trao đổi ngoại tệ, chiết khấu thương phiếu, nhận tiền gửi, cho vay thương mại, bảo quản vật có giá, tài trợ cho hoạt động của Chính Phủ (chiến tranh), cung cấp các dịch vụ ủy thác.',2014,9,9,1),(10,'Quản trị thương hiệu','Một thương hiệu còn bao gồm những trải nghiệm và cảm xúc mà khách hàng có đƣợc khi sử dụng sản phẩm, dịch vụ hay thậm chí bao gồm cả danh tiếng (về sản phẩm hay dịch vụ đó) mà thương hiệu đó có được thông qua những bài báo, những lời truyền miệng',2014,10,10,1),(11,'Tổng quan về tài chính doanh nghiệp','Doanh nghiệp là một tổ chức kinh tế thực hiện các hoạt động sản xuất , cung ứng hàng hóa cho người tiêu dùng qua thị trường nhằm mục đích sinh lời',2014,11,11,1),(12,'Nhập môn tài chính tiền tệ','Từ rất sớm trong lịch sử loài người đã xuất hiện nhu cầu phải có một hình thức tiền tệ làm trung gian trao đổi. Tuy nhiên quá trình phát triển các hình thái của tiền tệ cho thấy khó có thể đưa ra một định nghĩa về tiền tệ được các nhà kinh tế học thống nhất và chấp nhận. Trong tác phẩm góp phần phê phán khoa kinh tế chính t',2014,12,12,1),(13,'Lý thuyết và chính sách thương mại quốc tế','Xuất khẩu là một nội dung chính của hoạt động ngoại thương và nó đóng vai trò vô cùng quan trọng trong việc thúc đẩy tăng trưởng kinh tế của các quốc gia trong đó có Việt Nam.Có phải bạn muốn tìm: Chính  vì thế, Nhà nước đã và đang có những biện pháp thúc đẩy các ngành kinh tế hướng về xuất khẩu nhằm tận dụng hết những ích lợi của nó. Một trong số đó là chính sách xây dựng những mặt hàng chủ lực cho xuất khẩu.',2014,13,13,1),(14,'Tài nguyên du lịch','Theo tổ chức Du lịch quốc tế (1994) - hiểu theo phía cầu : Du lịch là một tập hợp các hoạt động và dịch vụ đa dạng, liên quan đến việc di chuyển tạm thời của con người ra khỏi nơi cư trú thường xuyên của họ nhằm mục đích tiêu khiển, nghỉ ngơi, văn hoá… và nhìn chung là vì những lý do không phải để kiếm sống.',2014,14,14,1);
...
INSERT INTO `tbl_taikhoan` VALUES (1,'haivv','haivv','Vũ Văn Hải','haivv.itedu@gmail.com','0123456789',0,1),(2,'admin','admin','Phạm Đình Công','congpd.itedu@gmail.com','0982207386',1,1);
...
INSERT INTO `tbl_tulieu` VALUES (1,'Những nguyên lý cơ bản của chủ nghĩa Mác – Lênin','Chương mở đầu: Nhập môn những nguyên lý cơ bản của chủ nghĩa Mác – Lênin.\r\nPhần thứ nhất: Thế giới quan và phương pháp luận triết học của chủ nghĩa Mác – Lênin\r\nChương 1: Chủ nghĩa duy vật biện chứng\r\nChương 2: Phép biện chứng duy vật\r\nChương 3: Chủ nghĩa duy vật lịch sử','Triết học','triethoc.net',2008,1),(2,'Bài giảng Toán cao cấp 1','I. Các kiến thức cơ bản\r\nII. Đại số tuyến tính\r\nIII. Phép tính vi phân hàm một biến thực\r\nIV. Phép tính tích phân hàm một biến\r\nV. Phép tính vi phân hàm nhiều biến\r\nVI. Tích phân bội\r\nVII. Tích phân đường - Tích phân mặt','Toán học','baigiangtoanhoc.com',2010,1),(3,'Bài giảng về nguyên lý kế toán','I. Khái niệm hạch toán kế toán\r\nII.Khái niệm kế toán \r\nIII. Vị trí của hạch toán kế toán trong hệ thông quản lý','Kế Toán','tailieuhoctap.vn',2013,1),(4,'Bài giảng kiểm toán căn bản','I. Bản chất của kiểm toán\r\nII. Quá trình phát triển của kiểm toán\r\nIII. Phân lọa kiểm toán','kiểm toán','doc.edu.vn/',2012,1),(5,'Giáo trình triết học Mác - Lênin','Chương 1: Triết học và vai trò của nó trong đời sống xã hội .\r\nChương 2: Khái lược lịch sử triết học trước mác .\r\nChương 3: Sự ra đời và phát triển của triết học .Mác - Lênin .\r\nChương 4: Vật chất và ý thức .\r\nChương 5: Hai nguyên lý cơ bản của phép biện chứng duy vật .','Triết học','triethoc.net',2012,1),(6,'Kinh tế chính trị và những điều cơ bản','1. Người sáng lập\r\n2.Phương pháp luận\r\n3.Những đặc điểm cơ bản','Triết học','tailieu.vn',2010,1),(7,'Tiếng Anh (A1)',' Buổi 1: Giới thiệu chung về khóa học, xây dựng kế hoạch tự học, \r\nhướng dẫn học kiến thức ngôn ngữ\r\n Buổi 2: Hướng dẫn học kỹ năng (Nghe-Nói-Đọc-Viết) và làm\r\nquen với dạng thức đề thi hết môn','Tiếng Anh A1','ulis.vnu.edu.vn',2013,1),(8,'Tiếng anh chuyên ngành QTKD','I. INTRODUCTION\r\nII.UNIT OBJECTIVES\r\nIII. CONTENTS','Tiếng anh chuyên ngành','tailieuhoctap.vn',2009,1),(9,'Đại cương về quản trị kinh doanh ngân hàng','1.Tổng quan về quản trị kinh doanh NH\r\n2.Quản trị huy động vốn\r\n3.Quản trị vốn tự có\r\n4.Quản trị Thanh khoản','Quản trị kinh doanh ngân hàng','tailieu.vn',2014,1),(10,'Quản trị thương hiệu','I. Tổng quan về thương hiệu\r\nII. Chiến lược quản trị thương hiệu\r\nIII. Bảo vệ thương hiệu','Quản trị kinh doanh ngân hàng','www.slideshare.net/',2014,1),(11,'Tổng quan về tài chính doanh nghiệp','I. Vai trò của Tài chính doanh nghiệp\r\nII Nội dung và  các nhân tố  ảnh hưởng tới Tài chính doanh nghiệp  ','Tài chính doanh nghiệp','tailieu.vn',2014,1),(12,'Nhập môn tài chính tiền tệ','Chương I:  Nhập môn Tài chính tiền tệ\r\nChương II: Lý luận tài chính\r\nChương III: Tiền tệ\r\nChương IV:Tài chính công','Tài chính doanh nghiệp','fpf.ueh.edu.vn',2013,1),(13,'Lý thuyết và chính sách thương mại quốc tế','I. Khái quát về thương mại quốc tế\r\nII, Các lý thuyết thương mại cổ điển\r\nIII, Các lý thuyết hiện đại','Thương mại và Du lịch','123doc.vn',2014,1),(14,'Tài nguyên du lịch','I. Tài nguyên du lịch\r\nII. Tài nguyên du lịch tự nhiên','Thương mại và Du lịch','www.wattpad.com',2013,1);
...
-- Dump completed on 2014-06-22 22:56:47

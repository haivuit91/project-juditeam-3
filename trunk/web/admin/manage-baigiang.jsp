    ...
    <body>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel panel-default">
                ...
                <div class="col-md-3" style="background: #428bca;padding:5px;font-weight:bold;text-transform: uppercase;color:#ffffff">Tên bài giảng</div>
                ...
                <div class="col-md-3" style="background: #428bca;padding:5px;font-weight:bold;text-transform: uppercase;color:#ffffff">Tên GViên HSinh</div>
            ...
            <c:forEach items="${bgList}" var="bgList">
                <div class="panel panel-title">
                    ...
                    <div class="col-md-3" style="text-transform: inherit;padding:5px">${bgList.getTenBG()}</div>
                    ...
                    <div class="col-md-3" style="text-transform: inherit;padding:5px">${bgList.getGiangVienHocSinh().getTenGVHS()}</div>
